...
from wtforms import StringField, SelectField, BooleanField, FloatField, FileField, TextAreaField
from wtforms.validators import DataRequired, Length, Optional, NumberRange

class AdForm(FlaskForm):
    titlerequest = StringField('Title of ad', validators=[DataRequired(), Length(max=100)])
    ...
    rank = SelectField('Rank', choices=[('', 'Select an option')], validators=[Optional()])
